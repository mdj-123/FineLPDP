...
def get_df(rel, is_baseline=False, local=False):
    if is_baseline:
...
def recall_at_top_k(y_true, y_probs, k=0.2):
    ...
    recall = top_true.sum() / y_true.sum()
